      ...
      <div class="flex-auto p-6">
        <form method="POST" action="{{ route('users.store') }}" class="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <input type="text" name="name" value="{{ old('name') }}" required class="border border-gray-300 rounded-lg py-2 px-3 w-full" />
          ...
          <div>
            ...
            <input type="text" name="username" value="{{ old('username') }}" required class="border border-gray-300 rounded-lg py-2 px-3 w-full" />
          ...
          <div>
            ...
            <input type="email" name="email" value="{{ old('email') }}" class="border border-gray-300 rounded-lg py-2 px-3 w-full" />
          ...
          <div>
            ...
            <select name="role" class="border border-gray-300 rounded-lg py-2 px-3 w-full">
              ...
              @endif
              <option value="admin" @selected(old('role','user')==='admin')>Admin</option>
          ...
          <div>
            <label class="block mb-1 text-xs font-bold text-white">Password</label>
            <input type="password" name="password" required class="border border-gray-300 rounded-lg py-2 px-3 w-full" />
          ...
          <div>
            ...
            <input type="password" name="password_confirmation" required class="border border-gray-300 rounded-lg py-2 px-3 w-full" />
          </div>

          <div class="md:col-span-2 flex items-center gap-2 mt-2">
            <label class="inline-flex items-center">
              <input type="checkbox" name="is_approved" value="1" class="mr-2"> <span>Approved</span>
            </label>
          </div>
